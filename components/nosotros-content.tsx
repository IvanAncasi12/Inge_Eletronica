                ...
                {[
                    {
                      ...
                      desc: 'Diseño, implementación y mantenimiento de sistemas automatizados, controladores, sensores y procesos industriales.'
                    },
                    {
                      icon: Target,
                      title: 'Telecomunicaciones',
                      desc: 'Desarrollo, instalación y gestión de redes de comunicación, sistemas inalámbricos, fibra óptica y transmisión de datos.'
                    },
                    {
                      icon: TrendingUp,
                      title: 'Sistemas Electrónicos',
                      desc: 'Diseño y análisis de circuitos electrónicos, sistemas embebidos, instrumentación y dispositivos inteligentes.'
                    },
                    {
                      icon: MapPin,
                      title: 'Control y Robótica',
                      desc: 'Aplicación de sistemas de control, robótica, mecatrónica y soluciones tecnológicas para la industria y la investigación.'
                    }
                  ].map((item, idx) => (
